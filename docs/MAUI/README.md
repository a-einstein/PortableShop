...
### Maintenance
* In Windows 10, because of restriction on pathlength to 260, the solution may initially best be opened by 'Open With' VisualStudio from the filebrowser, instead of from within VisualStudio. This is in case symbolic links are created, which are not well supported by VisualStudio.